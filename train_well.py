...
def _train_model(
    ...
    # Sin física ni datos no hay nada que optimizar; devolvemos directamente.
...
def main(
    ...
    print("=" * 60)
    print(f"Pozo Infinito — Experimento completo (n={estado_n})")
    print(
    ...
    print(f"\n{'=' * 60}")
    print(f"RESULTADOS FINALES (Pozo Infinito | n={estado_n})")
...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------
    # Configuración BASE  (n=2, todo conservador)
    # ----------------------------------------------------------------
    BASE = dict(
        estado_n=2, L=1.0,
        epochs=10000,
    ...
    print(f"\n{'=' * 60}")
    print(f"ESTUDIO DE SENSIBILIDAD — Pozo Infinito")
